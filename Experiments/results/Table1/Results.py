...
high_dimension_dataset_path = ['8GLIOMA', '9leukemia', '10pixraw10P', '11ProstateGE', '12warpAR10P', '13SMKCAN187',
                               '14arcene']
# %%
fold_path_low = ['RFAE_exp_dw', 'RFAE_exp_dw_clf']

fold_path_low_mice = ['RFAE_exp_dw', 'RFAE_exp_dw_clf']

fold_path_high = ['RFAE_exp_dw', 'RFAE_exp_dw_clf']
# %%
cv_times_from = 0
cv_times_to = 5
# %%
...
for low_dimension_dataset_path_i in low_dimension_dataset_path:
    for fold_path_low_i in fold_path_low:
        ...
        if fold_path_low_i in ['RFAE_exp_dw', 'RFAE_exp_dw_clf']:
